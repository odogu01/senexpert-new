...
export default function PrintToolRequestPage() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen bg-white print-bg-white">
  ...
  if (!request) {
    return (
      <div className="p-6 flex items-center justify-center h-screen bg-white print-bg-white">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 print-content">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-900">{(request as any).location || '-'}</p>
          </div>
            ...
            <>
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-900">{(request as any).vehicle_no || '-'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Delivered To</label>
                  <p className="text-gray-900">{(request as any).delivered_to || '-'}</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className="text-sm font-medium text-gray-500">Delivered By</label>
                  <p className="text-gray-900">{(request as any).delivered_by || '-'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Received By</label>
                  <p className="text-gray-900">{(request as any).received_by || '-'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Received From</label>
                  <p className="text-gray-900">{(request as any).received_from || '-'}</p>
                </div>
              </div>
            </>
          )}
