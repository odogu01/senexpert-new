                      ...
                      <td className="px-4 lg:px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          {request.status === 'approved' && (
                            <button onClick={() => window.open(`/dashboard/financial-requests/${request.id}/print`, '_blank')} className="p-1 hover:bg-gray-100 rounded text-green-600"><Download className="w-4 h-4" /></button>
                          )}
                        </div>
                      </td>
                    </motion.tr>
              ...
              <div className="p-6 space-y-4">
                ...
                {selectedRequest.status === 'approved' && (
                  <div className="pt-4 border-t border-gray-200">
                    <button onClick={() => window.open(`/dashboard/financial-requests/${selectedRequest.id}/print`, '_blank')} className="w-full px-4 py-2 bg-[#0B3C6D] text-white rounded-lg hover:bg-[#0a325a] flex items-center justify-center gap-2">
